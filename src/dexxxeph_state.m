...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Select and cut-off only the required Chebyshev coefficients from the data
% record (array: "decbv") and store them into the array "chebycoef". 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % JD of the days in the data record period (typically 32 days)
% for i = 1 : tspan
%     if i == 1
%         JDtspan(i,1) = t1;
%     else
...
% end
% clear i
%delta_jd = JDtspan(tspan+1,1) - t2;
%JDtspan(tspan,1) = t2;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % Index of the "tjd" mapping to the data record period
% for i = 1 : tspan
%     if (tjd - JDtspan(i,1)) < 1 & (tjd - JDtspan(i,1)) > 0
%         JDtspan_indxmin = i;
%         tjd_indx = (tjd / JDtspan(i,1) - 1) + JDtspan_indxmin;
%     elseif tjd == JDtspan(i,1)
%         tjd_indx = i;
%     end
% end
% clear i
% tjd_indx
% tjd_indx = (tjd - JDtspan(1,1)) + 1
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
