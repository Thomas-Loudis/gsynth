function [GM,ae,Cnm,Snm,sCnm,sSnm,nmax] = gfc(egmfilename,n_trunc,sigma_shc)


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% gfc:  Earth Gravity Model
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Purpose:
%  Reading of Earth gravity model's spherical harmonic coefficients from
%  the .gfc file in the gfc format. EGM selection from the above list.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Gravity Models list : see egm.ls
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Input arguments:
...
%       ae = sscanf(line_ith,'%*s %e %*')
    ...
    if test == 1
      GLB_tide_system = sscanf(line_ith,'%*s %s %*');
    end
    clear test    
end
fclose(fid);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Remark:
% If n_trunc>1 and C10,C11,S10,S11 are not included in the .gfc file then
% the corresponding Cnm,Snm matrix elements are set to zero value by
% default. Thus, the problem of writing their values to 0 occurs when
% n_trunc=1 or 0.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
