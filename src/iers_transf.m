function [EOP,dEOP,EOP_inv,dEOP_inv] = iers_transf(mjd,eop,dpint)
global XYs_IAU200A


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Function: iers_transf(mjd,eop,iau2000,dpint).m
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Purpose
...
%  Conventions 2003. 
%  The transformation matrices that are required for the direct and the 
%  inverse tranformation are computed for position and velocity
%  coordinates.
%
%  see IERS Conventions 2003 Ch.5
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Input arguments:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Last modified:
%  10/04/2011  Upgrade and function's rename from IERS_EOP.m to iers_rot.m  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Precession-Nutation model IAU2000 (X,Y,s)
% (X,Y)IAU2000 in radians

% add VLBI corrections (dX,dY) prior to interpolation 
dX = (dX_VLBI / 3600) * (pi / 180);
dY = (dY_VLBI / 3600) * (pi / 180);
% Cancel VLBI corrections addition %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%777
...
% %% add VLBI corrections (dX,dY) after interpolation 
% % VLBI corrections (dX,dY)
