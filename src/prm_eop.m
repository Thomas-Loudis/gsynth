function [EOP_data_array] = prm_eop(eopfilename, eop_interp_points, time_period, MJDo) 
...
[eopdat] = iers_eop(eopfilename,mjd_dp);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Read and set global X,y,s from IAU2000A precession-nutation model
global XYs_IAU200A
%XYsfilename = 'XYs_2009-10.dat';
XYsfilename = 'iau200a_XYs.dat'; 
%XYsfilename = 'iau2006_XYs.dat'; 
eopdat_mjd = eopdat(:,1);
[XYs_IAU200A] = iers_XYs_read(eopdat_mjd,XYsfilename);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
