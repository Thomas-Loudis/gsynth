...
% the matrix elements varies from 1 to n. Therefore, in this function we
% add 1 to the respective matrix element index for each coefficient index
% value.
% Example:
...
T(2,1) = T1;
% for i = 2 : n-1
%     T(i+1,1) = 2 * taph * T(i-1+1,1) - T(i-2+1,1);
% end
for i = 1 : n-1
